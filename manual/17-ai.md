...
| `prime-agent` | [Prime Agent](https://primeintellect.ai)                      |
...
Prime Agent is the other one without a mise stub: it installs through its own bootstrap script, which the default agent picker runs the first time you select it.
